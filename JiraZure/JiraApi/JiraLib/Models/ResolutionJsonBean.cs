...
namespace JiraLib.Models {
    ...
    public class ResolutionJsonBean : IParsable 
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ResolutionJsonBean"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ResolutionJsonBean CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ResolutionJsonBean();
        }
        /// <summary>
