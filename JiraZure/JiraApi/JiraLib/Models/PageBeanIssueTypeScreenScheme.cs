...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanIssueTypeScreenScheme : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanIssueTypeScreenScheme CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanIssueTypeScreenScheme();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<IssueTypeScreenScheme>(IssueTypeScreenScheme.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
