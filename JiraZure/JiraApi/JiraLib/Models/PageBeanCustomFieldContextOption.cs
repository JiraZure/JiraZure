...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanCustomFieldContextOption : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanCustomFieldContextOption CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanCustomFieldContextOption();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<CustomFieldContextOption>(CustomFieldContextOption.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
