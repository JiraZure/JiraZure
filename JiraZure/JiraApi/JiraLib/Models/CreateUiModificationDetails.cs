...
namespace JiraLib.Models {
    ...
    /// </summary>
    public class CreateUiModificationDetails : IParsable 
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="CreateUiModificationDetails"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static CreateUiModificationDetails CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CreateUiModificationDetails();
        }
        /// <summary>
