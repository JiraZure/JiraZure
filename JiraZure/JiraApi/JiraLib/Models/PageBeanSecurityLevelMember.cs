...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanSecurityLevelMember : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanSecurityLevelMember CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanSecurityLevelMember();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<SecurityLevelMember>(SecurityLevelMember.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
