...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanResolutionJsonBean : IParsable 
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="PageBeanResolutionJsonBean"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static PageBeanResolutionJsonBean CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanResolutionJsonBean();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<ResolutionJsonBean>(ResolutionJsonBean.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
