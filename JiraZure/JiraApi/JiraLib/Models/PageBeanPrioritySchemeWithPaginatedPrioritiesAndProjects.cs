...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanPrioritySchemeWithPaginatedPrioritiesAndProjects : IParsable 
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<PrioritySchemeWithPaginatedPrioritiesAndProjects>? Values { get; private set; }
#nullable restore
#else
        public List<PrioritySchemeWithPaginatedPrioritiesAndProjects> Values { get; private set; }
#endif
        ...
        public static PageBeanPrioritySchemeWithPaginatedPrioritiesAndProjects CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanPrioritySchemeWithPaginatedPrioritiesAndProjects();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<PrioritySchemeWithPaginatedPrioritiesAndProjects>(PrioritySchemeWithPaginatedPrioritiesAndProjects.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
