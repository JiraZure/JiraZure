...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanUiModificationDetails : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanUiModificationDetails CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanUiModificationDetails();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<UiModificationDetails>(UiModificationDetails.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
