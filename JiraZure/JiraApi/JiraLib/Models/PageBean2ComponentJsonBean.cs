...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBean2ComponentJsonBean : IParsable 
    {
...
#nullable restore
        ...
        public static PageBean2ComponentJsonBean CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBean2ComponentJsonBean();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<ComponentJsonBean>(ComponentJsonBean.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
