...
namespace JiraLib.Models {
    ...
    /// </summary>
    public class WorkflowIDs : IParsable 
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="WorkflowIDs"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static WorkflowIDs CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new WorkflowIDs();
        }
        /// <summary>
