...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanComponentWithIssueCount : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanComponentWithIssueCount CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanComponentWithIssueCount();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<ComponentWithIssueCount>(ComponentWithIssueCount.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
