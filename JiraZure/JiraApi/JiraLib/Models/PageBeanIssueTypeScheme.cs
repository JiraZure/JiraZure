...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanIssueTypeScheme : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanIssueTypeScheme CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanIssueTypeScheme();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<IssueTypeScheme>(IssueTypeScheme.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
