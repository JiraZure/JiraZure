...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanCustomFieldContextProjectMapping : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanCustomFieldContextProjectMapping CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanCustomFieldContextProjectMapping();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<CustomFieldContextProjectMapping>(CustomFieldContextProjectMapping.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
