...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanWorkflowTransitionRules : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanWorkflowTransitionRules CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanWorkflowTransitionRules();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<WorkflowTransitionRules>(WorkflowTransitionRules.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
