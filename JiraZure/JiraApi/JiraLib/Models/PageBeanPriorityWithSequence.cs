...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanPriorityWithSequence : IParsable 
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<PriorityWithSequence>? Values { get; private set; }
#nullable restore
#else
        public List<PriorityWithSequence> Values { get; private set; }
#endif
        ...
        public static PageBeanPriorityWithSequence CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanPriorityWithSequence();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<PriorityWithSequence>(PriorityWithSequence.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
