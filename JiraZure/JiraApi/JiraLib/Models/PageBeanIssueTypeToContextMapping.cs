...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanIssueTypeToContextMapping : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanIssueTypeToContextMapping CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanIssueTypeToContextMapping();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<IssueTypeToContextMapping>(IssueTypeToContextMapping.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
