...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanIssueSecuritySchemeToProjectMapping : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanIssueSecuritySchemeToProjectMapping CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanIssueSecuritySchemeToProjectMapping();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<IssueSecuritySchemeToProjectMapping>(IssueSecuritySchemeToProjectMapping.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
