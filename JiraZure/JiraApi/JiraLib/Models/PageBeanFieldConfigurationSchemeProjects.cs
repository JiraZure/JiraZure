...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanFieldConfigurationSchemeProjects : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanFieldConfigurationSchemeProjects CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanFieldConfigurationSchemeProjects();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<FieldConfigurationSchemeProjects>(FieldConfigurationSchemeProjects.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
