...
namespace JiraLib.Models {
    ...
    /// </summary>
    public class TaskProgressBeanJsonNode : IParsable 
    {
...
#nullable restore
        ...
        public TaskProgressBeanJsonNode_status? Status { get; set; }
        ...
        /// </summary>
        /// <returns>A <see cref="TaskProgressBeanJsonNode"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static TaskProgressBeanJsonNode CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new TaskProgressBeanJsonNode();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"result", n => { Result = n.GetObjectValue<JsonNode>(JsonNode.CreateFromDiscriminatorValue); } },
                {"self", n => { Self = n.GetStringValue(); } },
                {"started", n => { Started = n.GetLongValue(); } },
                {"status", n => { Status = n.GetEnumValue<TaskProgressBeanJsonNode_status>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<JsonNode>("result", Result);
            writer.WriteStringValue("self", Self);
            writer.WriteLongValue("started", Started);
            writer.WriteEnumValue<TaskProgressBeanJsonNode_status>("status", Status);
