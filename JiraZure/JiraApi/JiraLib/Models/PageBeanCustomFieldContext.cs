...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanCustomFieldContext : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanCustomFieldContext CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanCustomFieldContext();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<CustomFieldContext>(CustomFieldContext.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
