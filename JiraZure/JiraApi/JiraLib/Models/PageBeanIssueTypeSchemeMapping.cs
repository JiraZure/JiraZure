...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanIssueTypeSchemeMapping : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanIssueTypeSchemeMapping CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanIssueTypeSchemeMapping();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<IssueTypeSchemeMapping>(IssueTypeSchemeMapping.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
