...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanWorkflowScheme : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanWorkflowScheme CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanWorkflowScheme();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<WorkflowScheme>(WorkflowScheme.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
