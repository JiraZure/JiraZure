...
namespace JiraLib.Models {
    ...
    /// </summary>
    public class UserList : IParsable 
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="UserList"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static UserList CreateFromDiscriminatorValue(IParseNode parseNode)
        {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"items", n => { Items = n.GetCollectionOfObjectValues<User>(User.CreateFromDiscriminatorValue)?.ToList(); } },
