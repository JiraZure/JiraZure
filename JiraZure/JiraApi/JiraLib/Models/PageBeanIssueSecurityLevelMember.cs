...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanIssueSecurityLevelMember : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanIssueSecurityLevelMember CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanIssueSecurityLevelMember();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<IssueSecurityLevelMember>(IssueSecurityLevelMember.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
