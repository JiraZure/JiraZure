...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanIssueTypeScreenSchemeItem : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanIssueTypeScreenSchemeItem CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanIssueTypeScreenSchemeItem();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<IssueTypeScreenSchemeItem>(IssueTypeScreenSchemeItem.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
