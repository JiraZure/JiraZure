...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanIssueTypeSchemeProjects : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanIssueTypeSchemeProjects CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanIssueTypeSchemeProjects();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<IssueTypeSchemeProjects>(IssueTypeSchemeProjects.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
