...
namespace JiraLib.Models {
    ...
    /// </summary>
    public class WorkflowTransitionRule : IParsable 
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="WorkflowTransitionRule"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static WorkflowTransitionRule CreateFromDiscriminatorValue(IParseNode parseNode)
        {
