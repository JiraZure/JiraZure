...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanIssueFieldOption : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanIssueFieldOption CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanIssueFieldOption();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<IssueFieldOption>(IssueFieldOption.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
