...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanSecuritySchemeWithProjects : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanSecuritySchemeWithProjects CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanSecuritySchemeWithProjects();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<SecuritySchemeWithProjects>(SecuritySchemeWithProjects.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
