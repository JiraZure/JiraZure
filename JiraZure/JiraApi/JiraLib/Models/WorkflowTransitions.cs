...
namespace JiraLib.Models {
    ...
    /// </summary>
    public class WorkflowTransitions : IParsable 
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public WorkflowTransitions_properties? Properties { get; set; }
#nullable restore
#else
        public WorkflowTransitions_properties Properties { get; set; }
#endif
...
#nullable restore
        ...
        public WorkflowTransitions_type? Type { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="WorkflowTransitions"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static WorkflowTransitions CreateFromDiscriminatorValue(IParseNode parseNode)
        {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"conditions", n => { Conditions = n.GetObjectValue<ConditionGroupConfiguration>(ConditionGroupConfiguration.CreateFromDiscriminatorValue); } },
                {"customIssueEventId", n => { CustomIssueEventId = n.GetStringValue(); } },
                {"description", n => { Description = n.GetStringValue(); } },
                {"from", n => { From = n.GetCollectionOfObjectValues<WorkflowStatusAndPort>(WorkflowStatusAndPort.CreateFromDiscriminatorValue)?.ToList(); } },
                {"id", n => { Id = n.GetStringValue(); } },
                {"name", n => { Name = n.GetStringValue(); } },
                {"properties", n => { Properties = n.GetObjectValue<WorkflowTransitions_properties>(WorkflowTransitions_properties.CreateFromDiscriminatorValue); } },
                {"to", n => { To = n.GetObjectValue<WorkflowStatusAndPort>(WorkflowStatusAndPort.CreateFromDiscriminatorValue); } },
                ...
                {"type", n => { Type = n.GetEnumValue<WorkflowTransitions_type>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<ConditionGroupConfiguration>("conditions", Conditions);
            writer.WriteStringValue("customIssueEventId", CustomIssueEventId);
            writer.WriteStringValue("description", Description);
            writer.WriteCollectionOfObjectValues<WorkflowStatusAndPort>("from", From);
            writer.WriteStringValue("id", Id);
            writer.WriteStringValue("name", Name);
            writer.WriteObjectValue<WorkflowTransitions_properties>("properties", Properties);
            writer.WriteObjectValue<WorkflowStatusAndPort>("to", To);
            ...
            writer.WriteEnumValue<WorkflowTransitions_type>("type", Type);
