...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanScreenWithTab : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanScreenWithTab CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanScreenWithTab();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<ScreenWithTab>(ScreenWithTab.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
