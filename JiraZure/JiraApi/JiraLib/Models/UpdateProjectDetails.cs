...
namespace JiraLib.Models {
    ...
    /// </summary>
    public class UpdateProjectDetails : IParsable 
    {
        /// <summary>The default assignee when creating issues for this project.</summary>
        public UpdateProjectDetails_assigneeType? AssigneeType { get; set; }
        /// <summary>An integer value for the project&apos;s avatar.</summary>
        public long? AvatarId { get; set; }
        /// <summary>The ID of the project&apos;s category. A complete list of category IDs is found using the [Get all project categories](#api-rest-api-3-projectCategory-get) operation. To remove the project category from the project, set the value to `-1.`</summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="UpdateProjectDetails"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static UpdateProjectDetails CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new UpdateProjectDetails();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                {"assigneeType", n => { AssigneeType = n.GetEnumValue<UpdateProjectDetails_assigneeType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<UpdateProjectDetails_assigneeType>("assigneeType", AssigneeType);
