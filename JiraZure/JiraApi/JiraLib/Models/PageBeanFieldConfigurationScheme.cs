...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanFieldConfigurationScheme : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanFieldConfigurationScheme CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanFieldConfigurationScheme();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<FieldConfigurationScheme>(FieldConfigurationScheme.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
