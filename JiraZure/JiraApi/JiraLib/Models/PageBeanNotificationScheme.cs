...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanNotificationScheme : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanNotificationScheme CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanNotificationScheme();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<NotificationScheme>(NotificationScheme.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
