...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanFieldConfigurationIssueTypeItem : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanFieldConfigurationIssueTypeItem CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanFieldConfigurationIssueTypeItem();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<FieldConfigurationIssueTypeItem>(FieldConfigurationIssueTypeItem.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
