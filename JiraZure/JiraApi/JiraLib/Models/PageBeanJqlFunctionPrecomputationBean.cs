...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanJqlFunctionPrecomputationBean : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanJqlFunctionPrecomputationBean CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanJqlFunctionPrecomputationBean();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<JqlFunctionPrecomputationBean>(JqlFunctionPrecomputationBean.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
