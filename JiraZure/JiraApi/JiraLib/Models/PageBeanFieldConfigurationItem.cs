...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanFieldConfigurationItem : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanFieldConfigurationItem CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanFieldConfigurationItem();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<FieldConfigurationItem>(FieldConfigurationItem.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
