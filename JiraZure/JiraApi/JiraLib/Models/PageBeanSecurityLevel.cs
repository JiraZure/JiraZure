...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanSecurityLevel : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanSecurityLevel CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanSecurityLevel();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<SecurityLevel>(SecurityLevel.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
