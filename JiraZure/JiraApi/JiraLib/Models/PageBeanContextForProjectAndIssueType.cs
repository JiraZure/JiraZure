...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanContextForProjectAndIssueType : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanContextForProjectAndIssueType CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanContextForProjectAndIssueType();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<ContextForProjectAndIssueType>(ContextForProjectAndIssueType.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
