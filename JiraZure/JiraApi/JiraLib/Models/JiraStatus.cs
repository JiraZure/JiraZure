...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<JiraLib.Models.WorkflowUsages>? WorkflowUsages { get; set; }
#nullable restore
#else
        public List<JiraLib.Models.WorkflowUsages> WorkflowUsages { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="JiraStatus"/></returns>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"workflowUsages", n => { WorkflowUsages = n.GetCollectionOfObjectValues<JiraLib.Models.WorkflowUsages>(JiraLib.Models.WorkflowUsages.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<JiraLib.Models.WorkflowUsages>("workflowUsages", WorkflowUsages);
        }
    }
}
