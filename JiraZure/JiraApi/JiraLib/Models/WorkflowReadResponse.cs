...
namespace JiraLib.Models {
    ...
    /// </summary>
    public class WorkflowReadResponse : IParsable 
    {
...
#nullable restore
        ...
        public static WorkflowReadResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new WorkflowReadResponse();
        }
        /// <summary>
