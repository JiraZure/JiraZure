...
namespace JiraLib.Models {
    ...
    /// A page of items.
    /// </summary>
    public class PageBeanCustomFieldContextDefaultValue : IParsable 
    {
...
#nullable restore
        ...
        public static PageBeanCustomFieldContextDefaultValue CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PageBeanCustomFieldContextDefaultValue();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"values", n => { Values = n.GetCollectionOfObjectValues<CustomFieldContextDefaultValue>(CustomFieldContextDefaultValue.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
