...
using System;
namespace JiraLib.Rest.Api.Three.Universal_avatar.View.TypeNamespace.Item.Owner.Item {
    /// <summary>
    /// Builds and executes requests for operations under \rest\api\3\universal_avatar\view\type\{type}\owner\{entityId}
    /// </summary>
    public class WithEntityItemRequestBuilder : BaseRequestBuilder 
    {
        ...
        public WithEntityItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/universal_avatar/view/type/{type}/owner/{entityId}{?format*,size*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="WithEntityItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithEntityItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/universal_avatar/view/type/{type}/owner/{entityId}{?format*,size*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<StreamingResponseBody?> GetAsync(Action<RequestConfiguration<WithEntityItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<StreamingResponseBody> GetAsync(Action<RequestConfiguration<WithEntityItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<WithEntityItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<WithEntityItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// Returns the avatar image for a project or issue type.This operation can be accessed anonymously.**[Permissions](#permissions) required:** *  For system avatars, none. *  For custom project avatars, *Browse projects* [project permission](https://confluence.atlassian.com/x/yodKLg) for the project the avatar belongs to. *  For custom issue type avatars, *Browse projects* [project permission](https://confluence.atlassian.com/x/yodKLg) for at least one project the issue type is used in.
        /// </summary>
        public class WithEntityItemRequestBuilderGetQueryParameters 
        {
...
#nullable restore
        ...
        public class WithEntityItemRequestBuilderGetRequestConfiguration : RequestConfiguration<WithEntityItemRequestBuilderGetQueryParameters> 
        {
        }
    }
}
