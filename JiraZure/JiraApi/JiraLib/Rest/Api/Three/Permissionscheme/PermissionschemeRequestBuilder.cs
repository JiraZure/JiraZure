...
#nullable restore
        ...
        public async Task<PermissionSchemes> GetAsync(Action<RequestConfiguration<PermissionschemeRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<PermissionSchemes>(requestInfo, PermissionSchemes.CreateFromDiscriminatorValue, default,cancellationToken: cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
