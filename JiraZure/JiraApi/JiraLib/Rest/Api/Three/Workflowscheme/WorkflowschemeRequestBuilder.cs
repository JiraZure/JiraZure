...
#nullable restore
        ...
        public async Task<PageBeanWorkflowScheme> GetAsync(Action<RequestConfiguration<WorkflowschemeRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<PageBeanWorkflowScheme>(requestInfo, PageBeanWorkflowScheme.CreateFromDiscriminatorValue, default,cancellationToken: cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
