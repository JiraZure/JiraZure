...
using System;
namespace JiraLib.Rest.Api.Three.Workflowscheme.Item.Draft.Workflow {
    /// <summary>
    ...
    public class WorkflowRequestBuilder : BaseRequestBuilder 
    {
        ...
        public WorkflowRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/workflowscheme/{id}/draft/workflow?workflowName={workflowName}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="WorkflowRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WorkflowRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/workflowscheme/{id}/draft/workflow?workflowName={workflowName}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.GET, "{+baseurl}/rest/api/3/workflowscheme/{id}/draft/workflow{?workflowName*}", PathParameters);
            requestInfo.Configure(requestConfiguration);
