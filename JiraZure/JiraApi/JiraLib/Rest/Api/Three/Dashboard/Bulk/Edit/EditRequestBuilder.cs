...
using System;
namespace JiraLib.Rest.Api.Three.Dashboard.Bulk.Edit {
    /// <summary>
    ...
    public class EditRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// </summary>
        /// <returns>A <see cref="BulkEditShareableEntityResponse"/></returns>
...
#nullable enable
        public async Task<BulkEditShareableEntityResponse?> PutAsync(BulkEditShareableEntityRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<BulkEditShareableEntityResponse> PutAsync(BulkEditShareableEntityRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(BulkEditShareableEntityRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(BulkEditShareableEntityRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        public class EditRequestBuilderPutRequestConfiguration : RequestConfiguration<DefaultQueryParameters> 
        {
        }
    }
}
