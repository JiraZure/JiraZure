...
using System;
namespace JiraLib.Rest.Api.Three.Dashboard.Item.Copy {
    /// <summary>
    ...
    public class CopyRequestBuilder : BaseRequestBuilder 
    {
        ...
        public CopyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/dashboard/{dashboard%2Did}/copy", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="CopyRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CopyRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/dashboard/{dashboard%2Did}/copy", rawUrl)
        {
        }
        /// <summary>
