...
using JiraLib.Rest.Api.Three.Issue.Item.Assignee;
using JiraLib.Rest.Api.Three.Issue.Item.Attachments;
using JiraLib.Rest.Api.Three.Issue.Item.Changelog;
using JiraLib.Rest.Api.Three.Issue.Item.Comment;
using JiraLib.Rest.Api.Three.Issue.Item.Editmeta;
using JiraLib.Rest.Api.Three.Issue.Item.Notify;
using JiraLib.Rest.Api.Three.Issue.Item.Properties;
using JiraLib.Rest.Api.Three.Issue.Item.Remotelink;
using JiraLib.Rest.Api.Three.Issue.Item.Transitions;
using JiraLib.Rest.Api.Three.Issue.Item.Votes;
using JiraLib.Rest.Api.Three.Issue.Item.Watchers;
using JiraLib.Rest.Api.Three.Issue.Item.Worklog;
...
namespace JiraLib.Rest.Api.Three.Issue.Item {
    ...
    public class WithIssueIdOrKeyItemRequestBuilder : BaseRequestBuilder 
    {
        ...
        public ChangelogRequestBuilder Changelog
        {
            get => new ChangelogRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public EditmetaRequestBuilder Editmeta
        {
            get => new EditmetaRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The notify property</summary>
        public NotifyRequestBuilder Notify
        {
            get => new NotifyRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public RemotelinkRequestBuilder Remotelink
        {
            get => new RemotelinkRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public VotesRequestBuilder Votes
        {
            get => new VotesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The watchers property</summary>
        public WatchersRequestBuilder Watchers
        {
            get => new WatchersRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithIssueIdOrKeyItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/issue/{issueIdOrKey}{?deleteSubtasks*,expand*,fields*,fieldsByKeys*,notifyUsers*,overrideEditableFlag*,overrideScreenSecurity*,properties*,returnIssue*,updateHistory*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task DeleteAsync(Action<RequestConfiguration<WithIssueIdOrKeyItemRequestBuilderDeleteQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task DeleteAsync(Action<RequestConfiguration<WithIssueIdOrKeyItemRequestBuilderDeleteQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        ...
        /// </summary>
        /// <returns>A <see cref="IssueBean"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<IssueBean?> GetAsync(Action<RequestConfiguration<WithIssueIdOrKeyItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<IssueBean> GetAsync(Action<RequestConfiguration<WithIssueIdOrKeyItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<IssueBean>(requestInfo, IssueBean.CreateFromDiscriminatorValue, default,cancellationToken: cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<UntypedNode?> PutAsync(IssueUpdateDetails body, Action<RequestConfiguration<WithIssueIdOrKeyItemRequestBuilderPutQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<UntypedNode> PutAsync(IssueUpdateDetails body, Action<RequestConfiguration<WithIssueIdOrKeyItemRequestBuilderPutQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToDeleteRequestInformation(Action<RequestConfiguration<WithIssueIdOrKeyItemRequestBuilderDeleteQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToDeleteRequestInformation(Action<RequestConfiguration<WithIssueIdOrKeyItemRequestBuilderDeleteQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<WithIssueIdOrKeyItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<WithIssueIdOrKeyItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(IssueUpdateDetails body, Action<RequestConfiguration<WithIssueIdOrKeyItemRequestBuilderPutQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(IssueUpdateDetails body, Action<RequestConfiguration<WithIssueIdOrKeyItemRequestBuilderPutQueryParameters>> requestConfiguration = default)
...
#nullable restore
            ...
            /// <summary>Whether the issue&apos;s subtasks are deleted when the issue is deleted.</summary>
            [QueryParameter("deleteSubtasks")]
            public DeleteDeleteSubtasksQueryParameterType? DeleteSubtasksAsDeleteDeleteSubtasksQueryParameterType { get; set; }
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class WithIssueIdOrKeyItemRequestBuilderDeleteRequestConfiguration : RequestConfiguration<WithIssueIdOrKeyItemRequestBuilderDeleteQueryParameters> 
        {
        }
        /// <summary>
        /// Returns the details for an issue.The issue is identified by its ID or key, however, if the identifier doesn&apos;t match an issue, a case-insensitive search and check for moved issues is performed. If a matching issue is found its details are returned, a 302 or other redirect is **not** returned. The issue key returned in the response is the key of the issue found.This operation can be accessed anonymously.**[Permissions](#permissions) required:** *  *Browse projects* [project permission](https://confluence.atlassian.com/x/yodKLg) for the project that the issue is in. *  If [issue-level security](https://confluence.atlassian.com/x/J4lKLg) is configured, issue-level security permission to view the issue.
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class WithIssueIdOrKeyItemRequestBuilderGetRequestConfiguration : RequestConfiguration<WithIssueIdOrKeyItemRequestBuilderGetQueryParameters> 
        {
        }
        /// <summary>
        /// Edits an issue. Issue properties may be updated as part of the edit. Please note that issue transition will be ignored as it is not supported yet.The edits to the issue&apos;s fields are defined using `update` and `fields`. The fields that can be edited are determined using [ Get edit issue metadata](#api-rest-api-3-issue-issueIdOrKey-editmeta-get).The parent field may be set by key or ID. For standard issue types, the parent may be removed by setting `update.parent.set.none` to *true*. Note that the `description`, `environment`, and any `textarea` type custom fields (multi-line text fields) take Atlassian Document Format content. Single line custom fields (`textfield`) accept a string and don&apos;t handle Atlassian Document Format content.Connect apps having an app user with *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg), and Forge apps acting on behalf of users with *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg), can override the screen security configuration using `overrideScreenSecurity` and `overrideEditableFlag`.This operation can be accessed anonymously.**[Permissions](#permissions) required:** *  *Browse projects* and *Edit issues* [project permission](https://confluence.atlassian.com/x/yodKLg) for the project that the issue is in. *  If [issue-level security](https://confluence.atlassian.com/x/J4lKLg) is configured, issue-level security permission to view the issue.
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class WithIssueIdOrKeyItemRequestBuilderPutRequestConfiguration : RequestConfiguration<WithIssueIdOrKeyItemRequestBuilderPutQueryParameters> 
        {
        }
    }
}
