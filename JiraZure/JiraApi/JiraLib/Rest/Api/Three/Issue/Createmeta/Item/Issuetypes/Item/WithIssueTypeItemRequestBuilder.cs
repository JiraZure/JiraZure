...
using System;
namespace JiraLib.Rest.Api.Three.Issue.Createmeta.Item.Issuetypes.Item {
    /// <summary>
...
#nullable enable
        public async Task<PageOfCreateMetaIssueTypeWithField?> GetAsync(Action<RequestConfiguration<WithIssueTypeItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<PageOfCreateMetaIssueTypeWithField> GetAsync(Action<RequestConfiguration<WithIssueTypeItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
