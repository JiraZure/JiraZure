...
using JiraLib.Rest.Api.Three.Issue.Properties.Item;
using JiraLib.Rest.Api.Three.Issue.Properties.Multi;
...
using System;
namespace JiraLib.Rest.Api.Three.Issue.Properties {
    /// <summary>
    ...
    public class PropertiesRequestBuilder : BaseRequestBuilder 
    {
        ...
        {
            get => new MultiRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Gets an item from the JiraLib.rest.api.Three.issue.properties.item collection</summary>
...
#nullable enable
        public async Task PostAsync(IssueEntityProperties body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task PostAsync(IssueEntityProperties body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(IssueEntityProperties body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(IssueEntityProperties body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
