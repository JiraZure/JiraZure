...
using System;
namespace JiraLib.Rest.Api.Three.Priority.Search {
    /// <summary>
    ...
    public class SearchRequestBuilder : BaseRequestBuilder 
    {
        ...
        public SearchRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/priority/search{?expand*,id*,maxResults*,onlyDefault*,priorityName*,projectId*,startAt*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="SearchRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SearchRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/priority/search{?expand*,id*,maxResults*,onlyDefault*,priorityName*,projectId*,startAt*}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="PageBeanPriority"/></returns>
...
#nullable enable
        public async Task<PageBeanPriority?> GetAsync(Action<RequestConfiguration<SearchRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<PageBeanPriority> GetAsync(Action<RequestConfiguration<SearchRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
