...
#nullable restore
        ...
        public async Task<PageBeanScreen> GetAsync(Action<RequestConfiguration<ScreensRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<PageBeanScreen>(requestInfo, PageBeanScreen.CreateFromDiscriminatorValue, default,cancellationToken: cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
