...
using System;
namespace JiraLib.Rest.Api.Three.Issues.Archive.Export {
    /// <summary>
    ...
    public class ExportRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// </summary>
        /// <returns>A <see cref="ExportArchivedIssuesTaskProgressResponse"/></returns>
...
#nullable enable
        public async Task<ExportArchivedIssuesTaskProgressResponse?> PutAsync(ArchivedIssuesFilterRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<ExportArchivedIssuesTaskProgressResponse> PutAsync(ArchivedIssuesFilterRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(ArchivedIssuesFilterRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(ArchivedIssuesFilterRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        public class ExportRequestBuilderPutRequestConfiguration : RequestConfiguration<DefaultQueryParameters> 
        {
        }
    }
}
