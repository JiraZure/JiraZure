...
using System;
namespace JiraLib.Rest.Api.Three.Notificationscheme.Project {
    /// <summary>
...
#nullable enable
        public async Task<PageBeanNotificationSchemeAndProjectMappingJsonBean?> GetAsync(Action<RequestConfiguration<ProjectRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<PageBeanNotificationSchemeAndProjectMappingJsonBean> GetAsync(Action<RequestConfiguration<ProjectRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
