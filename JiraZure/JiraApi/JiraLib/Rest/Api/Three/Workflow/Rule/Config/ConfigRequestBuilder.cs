...
#nullable restore
        ...
        public async Task<PageBeanWorkflowTransitionRules> GetAsync(Action<RequestConfiguration<ConfigRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<PageBeanWorkflowTransitionRules>(requestInfo, PageBeanWorkflowTransitionRules.CreateFromDiscriminatorValue, errorMapping,cancellationToken: cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
