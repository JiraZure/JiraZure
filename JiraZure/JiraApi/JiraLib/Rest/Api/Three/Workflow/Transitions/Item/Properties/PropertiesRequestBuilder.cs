...
#nullable restore
        ...
        public async Task<WorkflowTransitionProperty> GetAsync(Action<RequestConfiguration<PropertiesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<WorkflowTransitionProperty>(requestInfo, WorkflowTransitionProperty.CreateFromDiscriminatorValue, default,cancellationToken: cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
