...
using System;
namespace JiraLib.Rest.Api.Three.Group.Member {
    /// <summary>
    ...
    public class MemberRequestBuilder : BaseRequestBuilder 
    {
        ...
        public MemberRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/group/member{?groupId*,groupname*,includeInactiveUsers*,maxResults*,startAt*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="MemberRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MemberRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/group/member{?groupId*,groupname*,includeInactiveUsers*,maxResults*,startAt*}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="PageBeanUserDetails"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PageBeanUserDetails?> GetAsync(Action<RequestConfiguration<MemberRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<PageBeanUserDetails> GetAsync(Action<RequestConfiguration<MemberRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
