...
using System;
namespace JiraLib.Rest.Api.Three.Project.Item.Avatar.Item {
    /// <summary>
    /// Builds and executes requests for operations under \rest\api\3\project\{projectIdOrKey-id}\avatar\{id}
    /// </summary>
    public class AvatarItemRequestBuilder : BaseRequestBuilder 
    {
        ...
        public AvatarItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/project/{projectIdOrKey%2Did}/avatar/{id}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="AvatarItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AvatarItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/project/{projectIdOrKey%2Did}/avatar/{id}", rawUrl)
        {
        }
        /// <summary>
