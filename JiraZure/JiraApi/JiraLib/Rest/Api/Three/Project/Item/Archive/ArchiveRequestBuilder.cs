...
using System;
namespace JiraLib.Rest.Api.Three.Project.Item.Archive {
    /// <summary>
    /// Builds and executes requests for operations under \rest\api\3\project\{projectIdOrKey-id}\archive
    /// </summary>
    public class ArchiveRequestBuilder : BaseRequestBuilder 
    {
        ...
        public ArchiveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/project/{projectIdOrKey%2Did}/archive", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ArchiveRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ArchiveRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/project/{projectIdOrKey%2Did}/archive", rawUrl)
        {
        }
        /// <summary>
