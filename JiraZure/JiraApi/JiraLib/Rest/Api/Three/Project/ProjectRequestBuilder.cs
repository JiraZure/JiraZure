...
using JiraLib.Rest.Api.Three.Project.Item;
using JiraLib.Rest.Api.Three.Project.Recent;
using JiraLib.Rest.Api.Three.Project.Search;
using JiraLib.Rest.Api.Three.Project.TypeNamespace;
...
using System;
namespace JiraLib.Rest.Api.Three.Project {
    /// <summary>
    ...
    public class ProjectRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// <summary>Gets an item from the JiraLib.rest.api.Three.project.item collection</summary>
        ...
        public ProjectIdOrKeyItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("projectIdOrKey%2Did", position);
                return new ProjectIdOrKeyItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
...
#nullable enable
        public async Task<List<JiraLib.Models.Project>?> GetAsync(Action<RequestConfiguration<ProjectRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<JiraLib.Models.Project>> GetAsync(Action<RequestConfiguration<ProjectRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        ...
        /// </summary>
        /// <returns>A <see cref="ProjectIdentifiers"/></returns>
        /// <param name="body">Details about the project.</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ProjectIdentifiers?> PostAsync(CreateProjectDetails body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<ProjectIdentifiers> PostAsync(CreateProjectDetails body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<ProjectIdentifiers>(requestInfo, ProjectIdentifiers.CreateFromDiscriminatorValue, default,cancellationToken: cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Returns all projects visible to the user. Deprecated, use [ Get projects paginated](#api-rest-api-3-project-search-get) that supports search and pagination.This operation can be accessed anonymously.**[Permissions](#permissions) required:** Projects are returned only where the user has *Browse Projects* or *Administer projects* [project permission](https://confluence.atlassian.com/x/yodKLg) for the project.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(CreateProjectDetails body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(CreateProjectDetails body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
