...
using System;
namespace JiraLib.Rest.Api.Three.User.Assignable.Search {
    /// <summary>
    ...
    public class SearchRequestBuilder : BaseRequestBuilder 
    {
        ...
        public SearchRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/user/assignable/search{?accountId*,actionDescriptorId*,issueKey*,maxResults*,project*,query*,recommend*,sessionId*,startAt*,username*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="SearchRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SearchRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/user/assignable/search{?accountId*,actionDescriptorId*,issueKey*,maxResults*,project*,query*,recommend*,sessionId*,startAt*,username*}", rawUrl)
        {
        }
        /// <summary>
