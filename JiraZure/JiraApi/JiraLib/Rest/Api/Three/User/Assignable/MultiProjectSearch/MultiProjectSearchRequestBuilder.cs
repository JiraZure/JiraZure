...
using System;
namespace JiraLib.Rest.Api.Three.User.Assignable.MultiProjectSearch {
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="MultiProjectSearchRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MultiProjectSearchRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/user/assignable/multiProjectSearch?projectKeys={projectKeys}{&accountId*,maxResults*,query*,startAt*,username*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="MultiProjectSearchRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MultiProjectSearchRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/user/assignable/multiProjectSearch?projectKeys={projectKeys}{&accountId*,maxResults*,query*,startAt*,username*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<List<JiraLib.Models.User>?> GetAsync(Action<RequestConfiguration<MultiProjectSearchRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<JiraLib.Models.User>> GetAsync(Action<RequestConfiguration<MultiProjectSearchRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<MultiProjectSearchRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<MultiProjectSearchRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="MultiProjectSearchRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
...
#nullable restore
        ...
        public class MultiProjectSearchRequestBuilderGetRequestConfiguration : RequestConfiguration<MultiProjectSearchRequestBuilderGetQueryParameters> 
        {
        }
    }
}
