...
using System;
namespace JiraLib.Rest.Api.Three.User.Permission.Search {
    /// <summary>
    /// Builds and executes requests for operations under \rest\api\3\user\permission\search
    /// </summary>
    public class SearchRequestBuilder : BaseRequestBuilder 
    {
        ...
        public SearchRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/user/permission/search?permissions={permissions}{&accountId*,issueKey*,maxResults*,projectKey*,query*,startAt*,username*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="SearchRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SearchRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/user/permission/search?permissions={permissions}{&accountId*,issueKey*,maxResults*,projectKey*,query*,startAt*,username*}", rawUrl)
        {
        }
        /// <summary>
