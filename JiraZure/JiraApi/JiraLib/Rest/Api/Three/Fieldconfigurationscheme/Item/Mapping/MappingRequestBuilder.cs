...
using JiraLib.Rest.Api.Three.Fieldconfigurationscheme.Item.Mapping.Delete;
...
using System;
namespace JiraLib.Rest.Api.Three.Fieldconfigurationscheme.Item.Mapping {
    /// <summary>
...
#nullable enable
        public async Task PutAsync(AssociateFieldConfigurationsWithIssueTypesRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task PutAsync(AssociateFieldConfigurationsWithIssueTypesRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(AssociateFieldConfigurationsWithIssueTypesRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(AssociateFieldConfigurationsWithIssueTypesRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
