...
using System;
namespace JiraLib.Rest.Api.Three.Filter.Favourite {
    /// <summary>
...
#nullable enable
        public async Task<List<JiraLib.Models.Filter>?> GetAsync(Action<RequestConfiguration<FavouriteRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<JiraLib.Models.Filter>> GetAsync(Action<RequestConfiguration<FavouriteRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<FavouriteRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<FavouriteRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        public class FavouriteRequestBuilderGetRequestConfiguration : RequestConfiguration<FavouriteRequestBuilderGetQueryParameters> 
        {
        }
    }
}
