...
using JiraLib.Rest.Api.Three.Field.Search.Trashed;
...
namespace JiraLib.Rest.Api.Three.Field.Search {
    ...
    public class SearchRequestBuilder : BaseRequestBuilder 
    {
        ...
        public TrashedRequestBuilder Trashed
        {
            get => new TrashedRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        ...
        public SearchRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/field/search{?expand*,id*,maxResults*,orderBy*,query*,startAt*,type*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="SearchRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SearchRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/field/search{?expand*,id*,maxResults*,orderBy*,query*,startAt*,type*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<PageBeanField?> GetAsync(Action<RequestConfiguration<SearchRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<PageBeanField> GetAsync(Action<RequestConfiguration<SearchRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
