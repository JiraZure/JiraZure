...
using System;
namespace JiraLib.Rest.Api.Three.Field.Item.Context.Item.Issuetype.Remove {
    /// <summary>
    /// Builds and executes requests for operations under \rest\api\3\field\{field-id}\context\{contextId}\issuetype\remove
    /// </summary>
    public class RemoveRequestBuilder : BaseRequestBuilder 
    {
        ...
        public RemoveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/field/{field%2Did}/context/{contextId}/issuetype/remove", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="RemoveRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RemoveRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/field/{field%2Did}/context/{contextId}/issuetype/remove", rawUrl)
        {
        }
        /// <summary>
