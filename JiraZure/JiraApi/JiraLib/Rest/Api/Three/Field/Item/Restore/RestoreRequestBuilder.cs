...
using System;
namespace JiraLib.Rest.Api.Three.Field.Item.Restore {
    /// <summary>
    /// Builds and executes requests for operations under \rest\api\3\field\{field-id}\restore
    /// </summary>
    public class RestoreRequestBuilder : BaseRequestBuilder 
    {
        ...
        public RestoreRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/field/{field%2Did}/restore", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="RestoreRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RestoreRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/field/{field%2Did}/restore", rawUrl)
        {
        }
        /// <summary>
