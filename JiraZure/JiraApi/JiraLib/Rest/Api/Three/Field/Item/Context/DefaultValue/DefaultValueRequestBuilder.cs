...
#nullable restore
        ...
        public async Task<PageBeanCustomFieldContextDefaultValue> GetAsync(Action<RequestConfiguration<DefaultValueRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<PageBeanCustomFieldContextDefaultValue>(requestInfo, PageBeanCustomFieldContextDefaultValue.CreateFromDiscriminatorValue, default,cancellationToken: cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
