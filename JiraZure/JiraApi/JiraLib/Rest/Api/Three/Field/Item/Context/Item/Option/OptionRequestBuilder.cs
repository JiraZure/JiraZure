...
using JiraLib.Rest.Api.Three.Field.Item.Context.Item.Option.Item;
using JiraLib.Rest.Api.Three.Field.Item.Context.Item.Option.Move;
...
using System;
namespace JiraLib.Rest.Api.Three.Field.Item.Context.Item.Option {
    /// <summary>
    ...
    public class OptionRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// <summary>Gets an item from the JiraLib.rest.api.Three.field.item.context.item.option.item collection</summary>
        ...
        /// </summary>
        /// <returns>A <see cref="PageBeanCustomFieldContextOption"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PageBeanCustomFieldContextOption?> GetAsync(Action<RequestConfiguration<OptionRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<PageBeanCustomFieldContextOption> GetAsync(Action<RequestConfiguration<OptionRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        ...
        /// </summary>
        /// <returns>A <see cref="CustomFieldCreatedContextOptionsList"/></returns>
        /// <param name="body">Details of the options to create for a custom field.</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<CustomFieldCreatedContextOptionsList?> PostAsync(BulkCustomFieldOptionCreateRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<CustomFieldCreatedContextOptionsList> PostAsync(BulkCustomFieldOptionCreateRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        ...
        /// </summary>
        /// <returns>A <see cref="CustomFieldUpdatedContextOptionsList"/></returns>
        /// <param name="body">Details of the options to update for a custom field.</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<CustomFieldUpdatedContextOptionsList?> PutAsync(BulkCustomFieldOptionUpdateRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<CustomFieldUpdatedContextOptionsList> PutAsync(BulkCustomFieldOptionUpdateRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(BulkCustomFieldOptionCreateRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(BulkCustomFieldOptionCreateRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(BulkCustomFieldOptionUpdateRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(BulkCustomFieldOptionUpdateRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class OptionRequestBuilderPutRequestConfiguration : RequestConfiguration<DefaultQueryParameters> 
        {
        }
    }
}
