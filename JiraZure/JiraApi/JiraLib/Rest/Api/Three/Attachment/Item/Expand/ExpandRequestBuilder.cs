// <auto-generated/>
using JiraLib.Rest.Api.Three.Attachment.Item.Expand.Human;
using JiraLib.Rest.Api.Three.Attachment.Item.Expand.Raw;
...
using System;
namespace JiraLib.Rest.Api.Three.Attachment.Item.Expand {
    /// <summary>
    ...
    public class ExpandRequestBuilder : BaseRequestBuilder 
    {
        ...
        public HumanRequestBuilder Human
        {
            get => new HumanRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The raw property</summary>
        public RawRequestBuilder Raw
        {
            get => new RawRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="ExpandRequestBuilder"/> and sets the default values.
        /// </summary>
