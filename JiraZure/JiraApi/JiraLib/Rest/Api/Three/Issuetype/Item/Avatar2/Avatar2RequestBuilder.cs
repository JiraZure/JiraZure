...
using System;
namespace JiraLib.Rest.Api.Three.Issuetype.Item.Avatar2 {
    /// <summary>
    ...
    public class Avatar2RequestBuilder : BaseRequestBuilder 
    {
        ...
        public Avatar2RequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/issuetype/{%2Did}/avatar2?size={size}{&x*,y*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="Avatar2RequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Avatar2RequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/api/3/issuetype/{%2Did}/avatar2?size={size}{&x*,y*}", rawUrl)
        {
        }
        /// <summary>
