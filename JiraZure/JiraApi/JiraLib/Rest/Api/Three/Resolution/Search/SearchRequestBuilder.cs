...
using System;
namespace JiraLib.Rest.Api.Three.Resolution.Search {
    /// <summary>
...
#nullable enable
        public async Task<PageBeanResolutionJsonBean?> GetAsync(Action<RequestConfiguration<SearchRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<PageBeanResolutionJsonBean> GetAsync(Action<RequestConfiguration<SearchRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
