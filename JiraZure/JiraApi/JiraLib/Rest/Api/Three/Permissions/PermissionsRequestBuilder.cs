...
using JiraLib.Rest.Api.Three.Permissions.Check;
using JiraLib.Rest.Api.Three.Permissions.Project;
...
using System;
namespace JiraLib.Rest.Api.Three.Permissions {
    /// <summary>
...
#nullable enable
        public async Task<JiraLib.Models.Permissions?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<JiraLib.Models.Permissions> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
