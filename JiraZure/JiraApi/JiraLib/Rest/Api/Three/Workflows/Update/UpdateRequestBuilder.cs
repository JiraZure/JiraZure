...
using JiraLib.Rest.Api.Three.Workflows.Update.Validation;
...
using System;
namespace JiraLib.Rest.Api.Three.Workflows.Update {
    /// <summary>
    ...
    public class UpdateRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// </summary>
        /// <returns>A <see cref="WorkflowUpdateResponse"/></returns>
        /// <param name="body">The update workflows payload.</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<WorkflowUpdateResponse?> PostAsync(WorkflowUpdateRequest body, Action<RequestConfiguration<UpdateRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<WorkflowUpdateResponse> PostAsync(WorkflowUpdateRequest body, Action<RequestConfiguration<UpdateRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<WorkflowUpdateResponse>(requestInfo, WorkflowUpdateResponse.CreateFromDiscriminatorValue, default,cancellationToken: cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Update workflows and related statuses.**[Permissions](#permissions) required:** *  *Administer Jira* project permission to create all, including global-scoped, workflows *  *Administer projects* project permissions to create project-scoped workflows
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(WorkflowUpdateRequest body, Action<RequestConfiguration<UpdateRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(WorkflowUpdateRequest body, Action<RequestConfiguration<UpdateRequestBuilderPostQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        public class UpdateRequestBuilderPostRequestConfiguration : RequestConfiguration<UpdateRequestBuilderPostQueryParameters> 
        {
        }
    }
}
